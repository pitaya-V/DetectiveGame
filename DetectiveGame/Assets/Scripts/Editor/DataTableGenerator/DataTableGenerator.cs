...
namespace DetectiveGame.Editor.DataTableTools
{
    public sealed class DataTableGenerator
    {
        private const string DataTablePath = "Assets/[Resources]/DataTables";
        private const string CSharpCodePath = "Assets/Scripts/Runtime/DataTable";
        private const string CSharpCodeTemplateFileName = "Assets/[Resources]/Configs/DataTableCodeTemplate.txt";
        ...
        private static void DataTableCodeGenerator(DataTableProcessor dataTableProcessor, StringBuilder codeContent, object userData)
        {
            ...
            codeContent.Replace("__DATA_TABLE_NAME_SPACE__", "DetectiveGame");
